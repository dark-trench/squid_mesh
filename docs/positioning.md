...
| Jido.Storage-backed core | Supported, evolving | Start, execution, replay, cancellation, inspection, explanation, pause, and approval controls run through the Jido journal runtime by default and do not write legacy runtime rows for the covered journal path. |
